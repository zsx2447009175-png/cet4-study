...
const DAILY_WORDS = [
  ...
  [{w:"mercy",p:"/ˈmɜːsi/",m:"n. 仁慈",c:"at the mercy of"},{w:"increasingly",p:"/ɪnˈkriːsɪŋli/",m:"adv. 日益",c:"increasingly popular"},{w:"owe",p:"/əʊ/",m:"v. 欠，归功于",c:"owe to"},{w:"dissolve",p:"/dɪˈzɒlv/",m:"v. 溶解",c:"dissolve in water"},{w:"whereas",p:"/ˌweərˈæz/",m:"conj. 然而",c:"whereas previously"},{w:"brand",p:"/brænd/",m:"n. 品牌",c:"brand image"},{w:"dynamic",p:"/daɪˈnæmɪk/",m:"adj. 动态的",c:"dynamic economy"},{w:"instrument",p:"/ˈɪnstrəmənt/",m:"n. 乐器",c:"musical instrument"},{w:"response",p:"/rɪˈspɒns/",m:"n. 回应",c:"in response to"},{w:"entertain",p:"/ˌentəˈteɪn/",m:"v. 娱乐",c:"entertain guests"},{w:"yield",p:"/jiːld/",m:"v. 产生，屈服",c:"yield results"},{w:"shift",p:"/ʃɪft/",m:"v./n. 转移，轮班",c:"night shift"},{w:"complaint",p:"/kəmˈpleɪnt/",m:"n. 投诉",c:"make a complaint"},{w:"emergency",p:"/ɪˈmɜːdʒənsi/",m:"n. 紧急情况",c:"emergency room"},{w:"celebrate",p:"/ˈselɪbreɪt/",m:"v. 庆祝",c:"celebrate success"},{w:"security",p:"/sɪˈkjʊərəti/",m:"n. 安全",c:"national security"},{w:"withdraw",p:"/wɪðˈdrɔː/",m:"v. 撤回",c:"withdraw from"},{w:"promote",p:"/prəˈməʊt/",m:"v. 促进，提升",c:"promote growth"},{w:"scope",p:"/skəʊp/",m:"n. 范围",c:"within the scope"},{w:"boost",p:"/buːst/",m:"v./n. 促进",c:"boost confidence"},{w:"severe",p:"/sɪˈvɪər/",m:"adj. 严重的",c:"severe weather"},{w:"drift",p:"/drɪft/",m:"v./n. 漂流",c:"drift apart"},{w:"standard",p:"/ˈstændəd/",m:"n. 标准 adj. 标准的",c:"high standard"},{w:"obvious",p:"/ˈɒbviəs/",m:"adj. 明显的",c:"obvious reason"},{w:"confront",p:"/kənˈfrʌnt/",m:"v. 面对",c:"confront challenges"},{w:"persist",p:"/pəˈsɪst/",m:"v. 坚持",c:"persist in"},{w:"investment",p:"/ɪnˈvestmənt/",m:"n. 投资",c:"return on investment"},{w:"amuse",p:"/əˈmjuːz/",m:"v. 逗乐",c:"amuse oneself"},{w:"grasp",p:"/ɡrɑːsp/",m:"v./n. 抓住，理解",c:"grasp the concept"},{w:"pace",p:"/peɪs/",m:"n. 速度",c:"keep pace with"},{w:"characteristic",p:"/ˌkærəktəˈrɪstɪk/",m:"n. 特征",c:"key characteristic"},{w:"genuine",p:"/ˈdʒenjuɪn/",m:"adj. 真正的",c:"genuine interest"},{w:"leadership",p:"/ˈliːdəʃɪp/",m:"n. 领导能力",c:"under the leadership"},{w:"entitle",p:"/ɪnˈtaɪtl/",m:"v. 给…权利",c:"be entitled to"},{w:"victim",p:"/ˈvɪktɪm/",m:"n. 受害者",c:"fall victim to"},{w:"draft",p:"/drɑːft/",m:"n. 草稿 v. 起草",c:"first draft"},{w:"similar",p:"/ˈsɪmələr/",m:"adj. 相似的",c:"similar to"},{w:"insurance",p:"/ɪnˈʃʊərəns/",m:"n. 保险",c:"health insurance"},{w:"amount",p:"/əˈmaʊnt/",m:"n. 数量",c:"a large amount of"},{w:"scheme",p:"/skiːm/",m:"n. 方案",c:"color scheme"},{w:"initial",p:"/ɪˈnɪʃl/",m:"adj. 最初的",c:"initial stage"},{w:"defeat",p:"/dɪˈfiːt/",m:"v./n. 击败",c:"defeat the enemy"},{w:"edition",p:"/ɪˈdɪʃn/",m:"n. 版本",c:"special edition"},{w:"boundary",p:"/ˈbaʊndri/",m:"n. 边界",c:"set boundaries"},{w:"portion",p:"/ˈpɔːʃn/",m:"n. 部分",c:"a large portion"},{w:"manufacture",p:"/ˌmænjuˈfæktʃər/",m:"v./n. 制造",c:"manufacture goods"},{w:"beloved",p:"/bɪˈlʌvd/",m:"adj. 心爱的",c:"beloved wife"},{w:"loan",p:"/ləʊn/",m:"n. 贷款 v. 借出",c:"bank loan"},{w:"regulation",p:"/ˌreɡjuˈleɪʃn/",m:"n. 法规",c:"government regulation"},{w:"derive",p:"/dɪˈraɪv/",m:"v. 源自",c:"derive from"},{w:"calculate",p:"/ˈkælkjuleɪt/",m:"v. 计算",c:"calculate risk"},{w:"reform",p:"/rɪˈfɔːm/",m:"v./n. 改革",c:"economic reform"},{w:"liability",p:"/ˌlaɪəˈbɪləti/",m:"n. 责任",c:"legal liability"},{w:"valid",p:"/ˈvælɪd/",m:"adj. 有效的",c:"valid passport"},{w:"commerce",p:"/ˈkɒmɜːs/",m:"n. 商业",c:"e-commerce"},{w:"fiction",p:"/ˈfɪkʃn/",m:"n. 小说",c:"science fiction"},{w:"circumstance",p:"/ˈsɜːkəmstəns/",m:"n. 环境",c:"under no circumstances"},{w:"audience",p:"/ˈɔːdiəns/",m:"n. 观众",c:"target audience"},{w:"circumstance",p:"/ˈsɜːkəmstæns/",m:"n. 情况",c:"under the circumstances"},{w:"scan",p:"/skæn/",m:"v./n. 扫描",c:"scan through"},{w:"contact",p:"/ˈkɒntækt/",m:"n./v. 联系",c:"keep in contact"},{w:"confidence",p:"/ˈkɒnfɪdəns/",m:"n. 信心",c:"build confidence"},{w:"intellectual",p:"/ˌɪntəˈlektʃuəl/",m:"adj. 智力的",c:"intellectual property"},{w:"label",p:"/ˈleɪbl/",m:"n. 标签 v. 标注",c:"warning label"},{w:"equivalent",p:"/ɪˈkwɪvələnt/",m:"adj. 等价的",c:"equivalent to"},{w:"bless",p:"/bles/",m:"v. 祝福",c:"bless with"},{w:"absence",p:"/ˈæbsəns/",m:"n. 缺席",c:"in the absence of"},{w:"site",p:"/saɪt/",m:"n. 地点",c:"construction site"},{w:"organic",p:"/ɔːˈɡænɪk/",m:"adj. 有机的",c:"organic food"},{w:"defend",p:"/dɪˈfend/",m:"v. 防御，辩护",c:"defend against"},{w:"compose",p:"/kəmˈpəʊz/",m:"v. 组成，创作",c:"compose music"},{w:"finance",p:"/ˈfaɪnæns/",m:"n. 金融",c:"personal finance"},{w:"pioneer",p:"/ˌpaɪəˈnɪər/",m:"n. 先驱 v. 开拓",c:"pioneer spirit"},{w:"undermine",p:"/ˌʌndəˈmaɪn/",m:"v. 削弱",c:"undermine confidence"},{w:"estate",p:"/ɪˈsteɪt/",m:"n. 房地产",c:"real estate"},{w:"publication",p:"/ˌpʌblɪˈkeɪʃn/",m:"n. 出版(物)",c:"scientific publication"},{w:"provision",p:"/prəˈvɪʒn/",m:"n. 供应，条款",c:"make provision for"},{w:"reward",p:"/rɪˈwɔːd/",m:"n. 奖赏 v. 报答",c:"reward for"},{w:"panel",p:"/ˈpænl/",m:"n. 面板，小组",c:"control panel"},{w:"decorate",p:"/ˈdekəreɪt/",m:"v. 装饰",c:"decorate the room"},{w:"civilization",p:"/ˌsɪvəlaɪˈzeɪʃn/",m:"n. 文明",c:"ancient civilization"},{w:"protest",p:"/ˈprəʊtest/",m:"n./v. 抗议",c:"protest against"},{w:"joint",p:"/dʒɔɪnt/",m:"adj. 联合的 n. 关节",c:"joint effort"},{w:"precaution",p:"/prɪˈkɔːʃn/",m:"n. 预防措施",c:"take precautions"},{w:"distinguish",p:"/dɪˈstɪŋɡwɪʃ/",m:"v. 区分",c:"distinguish between"},{w:"applicant",p:"/ˈæplɪkənt/",m:"n. 申请人",c:"job applicant"},{w:"hostile",p:"/ˈhɒstaɪl/",m:"adj. 敌对的",c:"hostile environment"},{w:"refer",p:"/rɪˈfɜːr/",m:"v. 参考",c:"refer to"},{w:"attend",p:"/əˈtend/",m:"v. 参加",c:"attend a meeting"},{w:"detail",ex:"Explain it in detail.",excn:"详细解释。",p:"/ˈdiːteɪl/",m:"n. 细节",c:"in detail"},{w:"principle",p:"/ˈprɪnsəpl/",m:"n. 原则",c:"basic principle"},{w:"vast",p:"/vɑːst/",m:"adj. 巨大的",c:"vast majority"},{w:"incident",p:"/ˈɪnsɪdənt/",m:"n. 事件",c:"isolated incident"},{w:"theme",p:"/θiːm/",m:"n. 主题",c:"main theme"},{w:"hence",p:"/hens/",m:"adv. 因此",c:"and hence"},{w:"overall",p:"/ˌəʊvərˈɔːl/",m:"adj. 总体的",c:"overall performance"},{w:"superior",p:"/suːˈpɪəriər/",m:"adj. 优越的",c:"superior quality"},{w:"core",p:"/kɔːr/",m:"n. 核心",c:"core value"},{w:"schedule",p:"/ˈʃedjuːl/",m:"n. 时间表",c:"on schedule"},{w:"embrace",p:"/ɪmˈbreɪs/",m:"v. 拥抱，接受",c:"embrace change"}],
  [{w:"request",p:"/rɪˈkwest/",m:"n./v. 请求",c:"make a request"},{w:"profession",p:"/prəˈfeʃn/",m:"n. 职业",c:"medical profession"},{w:"stock",p:"/stɒk/",m:"n. 库存，股票",c:"stock market"},{w:"opponent",p:"/əˈpəʊnənt/",m:"n. 对手",c:"political opponent"},{w:"permanent",p:"/ˈpɜːmənənt/",m:"adj. 永久的",c:"permanent resident"},{w:"recover",p:"/rɪˈkʌvər/",m:"v. 恢复",c:"recover from"},{w:"policy",p:"/ˈpɒləsi/",m:"n. 政策",c:"foreign policy"},{w:"arrest",p:"/əˈrest/",m:"v./n. 逮捕",c:"under arrest"},{w:"establish",ex:"They established new rules.",excn:"他们制定了新规则。",p:"/ɪˈstæblɪʃ/",m:"v. 建立",c:"establish a company"},{w:"logic",p:"/ˈlɒdʒɪk/",m:"n. 逻辑",c:"logic thinking"},{w:"fame",p:"/feɪm/",m:"n. 名声",c:"rise to fame"},{w:"command",p:"/kəˈmɑːnd/",m:"v./n. 命令，掌握",c:"have a command of"},{w:"executive",p:"/ɪɡˈzekjətɪv/",m:"adj. 执行的 n. 主管",c:"chief executive"},{w:"narrow",p:"/ˈnærəʊ/",m:"adj. 狭窄的",c:"narrow down"},{w:"employee",p:"/ɪmˈplɔɪiː/",m:"n. 雇员",c:"employee benefits"},{w:"voluntary",p:"/ˈvɒləntri/",m:"adj. 自愿的",c:"voluntary work"},{w:"destroy",p:"/dɪˈstrɔɪ/",m:"v. 破坏",c:"destroy evidence"},{w:"reasonable",p:"/ˈriːznəbl/",m:"adj. 合理的",c:"reasonable price"},{w:"pride",p:"/praɪd/",m:"n. 骄傲 v. 自豪",c:"take pride in"},{w:"trace",p:"/treɪs/",m:"v. 追踪 n. 痕迹",c:"trace back to"},{w:"chemical",p:"/ˈkemɪkl/",m:"adj. 化学的",c:"chemical reaction"},{w:"attention",p:"/əˈtenʃn/",m:"n. 注意",c:"pay attention to"},{w:"companion",p:"/kəmˈpæniən/",m:"n. 同伴",c:"travel companion"},{w:"digital",ex:"We live in the digital age.",excn:"我们生活在数字时代。",p:"/ˈdɪdʒɪtl/",m:"adj. 数字的",c:"digital age"},{w:"guidance",p:"/ˈɡaɪdns/",m:"n. 指导",c:"career guidance"},{w:"technique",p:"/tekˈniːk/",m:"n. 技术",c:"management technique"},{w:"input",p:"/ˈɪnpʊt/",m:"n./v. 输入",c:"input data"},{w:"formula",p:"/ˈfɔːmjələ/",m:"n. 公式",c:"mathematical formula"},{w:"alter",p:"/ˈɔːltər/",m:"v. 改变",c:"alter the course"},{w:"dominant",p:"/ˈdɒmɪnənt/",m:"adj. 主导的",c:"dominant position"},{w:"forecast",p:"/ˈfɔːkɑːst/",m:"n./v. 预测",c:"weather forecast"},{w:"inspect",p:"/ɪnˈspekt/",m:"v. 检查",c:"inspect carefully"},{w:"current",p:"/ˈkʌrənt/",m:"adj. 当前的",c:"current situation"},{w:"image",p:"/ˈɪmɪdʒ/",m:"n. 形象",c:"public image"},{w:"mobile",p:"/ˈməʊbaɪl/",m:"adj. 移动的",c:"mobile phone"},{w:"thorough",p:"/ˈθʌrə/",m:"adj. 彻底的",c:"thorough investigation"},{w:"narrative",p:"/ˈnærətɪv/",m:"n. 叙述",c:"personal narrative"},{w:"estimate",p:"/ˈestɪmeɪt/",m:"v./n. 估计",c:"rough estimate"},{w:"export",p:"/ɪkˈspɔːt/",m:"v./n. 出口",c:"export goods"},{w:"qualification",p:"/ˌkwɒlɪfɪˈkeɪʃn/",m:"n. 资格",c:"academic qualification"},{w:"cancel",p:"/ˈkænsl/",m:"v. 取消",c:"cancel order"},{w:"coordinate",p:"/kəʊˈɔːdɪneɪt/",m:"v. 协调",c:"coordinate efforts"},{w:"current",ex:"What is your current job?",excn:"你现在做什么工作？",p:"/ˈkʌrənt/",m:"adj. 当前的",c:"current situation"},{w:"constitute",p:"/ˈkɒnstɪtjuːt/",m:"v. 构成",c:"constitute a threat"},{w:"crucial",ex:"This is a crucial decision.",excn:"这是关键决定。",p:"/ˈkruːʃl/",m:"adj. 至关重要的",c:"crucial to"},{w:"battle",p:"/ˈbætl/",m:"n./v. 战斗",c:"battle against"},{w:"abroad",p:"/əˈbrɔːd/",m:"adv. 到国外",c:"study abroad"},{w:"recognition",p:"/ˌrekəɡˈnɪʃn/",m:"n. 认可",c:"facial recognition"},{w:"grateful",p:"/ˈɡreɪtfl/",m:"adj. 感激的",c:"be grateful for"},{w:"enterprise",p:"/ˈentəpraɪz/",m:"n. 企业",c:"private enterprise"},{w:"income",p:"/ˈɪnkʌm/",m:"n. 收入",c:"annual income"},{w:"election",p:"/ɪˈlekʃn/",m:"n. 选举",c:"general election"},{w:"alongside",p:"/əˌlɒŋˈsaɪd/",m:"prep. 在…旁边",c:"work alongside"},{w:"imagination",p:"/ɪˌmædʒɪˈneɪʃn/",m:"n. 想象力",c:"beyond imagination"},{w:"arrange",p:"/əˈreɪndʒ/",m:"v. 安排",c:"arrange for"},{w:"inspire",p:"/ɪnˈspaɪə(r)/",m:"v. 激励",c:"inspire sb to do"},{w:"combine",p:"/kəmˈbaɪn/",m:"v. 结合",c:"combine with"},{w:"calendar",p:"/ˈkælɪndər/",m:"n. 日历",c:"lunar calendar"},{w:"belief",p:"/bɪˈliːf/",m:"n. 信念",c:"beyond belief"},{w:"medium",p:"/ˈmiːdiəm/",m:"n. 媒介 adj. 中等的",c:"medium size"},{w:"publish",p:"/ˈpʌblɪʃ/",m:"v. 出版",c:"publish a book"},{w:"moreover",p:"/mɔːrˈəʊvər/",m:"adv. 此外",c:"moreover important"},{w:"delay",p:"/dɪˈleɪ/",m:"v./n. 延迟",c:"without delay"},{w:"immigrant",p:"/ˈɪmɪɡrənt/",m:"n. 移民",c:"illegal immigrant"},{w:"rational",p:"/ˈræʃnəl/",m:"adj. 理性的",c:"rational decision"},{w:"trial",p:"/ˈtraɪəl/",m:"n. 审判，试验",c:"clinical trial"},{w:"oppose",p:"/əˈpəʊz/",m:"v. 反对",c:"oppose the plan"},{w:"biology",p:"/baɪˈɒlədʒi/",m:"n. 生物学",c:"molecular biology"},{w:"sequence",p:"/ˈsiːkwəns/",m:"n. 顺序",c:"in sequence"},{w:"remote",p:"/rɪˈməʊt/",m:"adj. 遥远的",c:"remote control"},{w:"racial",p:"/ˈreɪʃl/",m:"adj. 种族的",c:"racial discrimination"},{w:"flourish",p:"/ˈflʌrɪʃ/",m:"v. 繁荣",c:"flourish in"},{w:"apology",p:"/əˈpɒlədʒi/",m:"n. 道歉",c:"make an apology"},{w:"charity",p:"/ˈtʃærəti/",m:"n. 慈善",c:"charity event"},{w:"bond",p:"/bɒnd/",m:"n. 纽带，债券",c:"emotional bond"},{w:"commission",p:"/kəˈmɪʃn/",m:"n. 委员会，佣金",c:"on commission"},{w:"candidate",p:"/ˈkændɪdət/",m:"n. 候选人",c:"presidential candidate"},{w:"release",p:"/rɪˈliːs/",m:"v./n. 释放，发布",c:"press release"},{w:"territory",p:"/ˈterətri/",m:"n. 领土",c:"new territory"},{w:"widespread",p:"/ˈwaɪdspred/",m:"adj. 广泛的",c:"widespread use"},{w:"layer",p:"/ˈleɪər/",m:"n. 层",c:"ozone layer"},{w:"intention",p:"/ɪnˈtenʃn/",m:"n. 意图",c:"good intention"},{w:"presumably",p:"/prɪˈzjuːməbli/",m:"adv. 大概",c:"presumably correct"},{w:"limitation",p:"/ˌlɪmɪˈteɪʃn/",m:"n. 限制",c:"statute of limitations"},{w:"spiritual",p:"/ˈspɪrɪtʃuəl/",m:"adj. 精神的",c:"spiritual life"},{w:"senior",p:"/ˈsiːniər/",m:"adj. 高级的 n. 年长者",c:"senior manager"},{w:"recall",p:"/rɪˈkɔːl/",m:"v./n. 回忆",c:"recall the past"},{w:"aid",p:"/eɪd/",m:"n./v. 帮助",c:"first aid"},{w:"demonstrate",p:"/ˈdemənstreɪt/",m:"v. 展示",c:"demonstrate ability"},{w:"admission",p:"/ədˈmɪʃn/",m:"n. 准许进入",c:"admission ticket"},{w:"civil",p:"/ˈsɪvl/",m:"adj. 公民的",c:"civil rights"},{w:"passive",p:"/ˈpæsɪv/",m:"adj. 被动的",c:"passive voice"},{w:"license",p:"/ˈlaɪsns/",m:"n. 许可证 v. 许可",c:"driver's license"},{w:"evidence",ex:"There is no evidence.",excn:"没有证据。",p:"/ˈevɪdəns/",m:"n. 证据",c:"scientific evidence"},{w:"passion",p:"/ˈpæʃn/",m:"n. 热情",c:"have a passion for"},{w:"operate",p:"/ˈɒpəreɪt/",m:"v. 操作",c:"operate a machine"},{w:"culture",p:"/ˈkʌltʃər/",m:"n. 文化",c:"corporate culture"},{w:"insight",p:"/ˈɪnsaɪt/",m:"n. 洞察力",c:"provide insight"},{w:"objective",p:"/əbˈdʒektɪv/",m:"n. 目标 adj. 客观的",c:"achieve objective"},{w:"debt",p:"/det/",m:"n. 债务",c:"in debt"}]
];
...
const WORD_POOL = [
  ...
  {w:"abolish",p:"/əˈbɒlɪʃ/",m:"v. 废除",c:"abolish slavery"},
  {w:"abortion",p:"/əˈbɔːʃn/",m:"n. 流产",c:"illegal abortion"},
  {w:"absolute",p:"/ˈæbsəluːt/",m:"adj. 绝对的",c:"absolute power"},
  {w:"absurd",p:"/əbˈsɜːd/",m:"adj. 荒谬的",c:"absurd idea"},
  {w:"accuse",p:"/əˈkjuːz/",m:"v. 指控",c:"accuse of"},
  ...
  {w:"alarm",p:"/əˈlɑːm/",m:"n. 警报",c:"fire alarm"},
  ...
  {w:"appointment",p:"/əˈpɔɪntmənt/",m:"n. 约会",c:"make an appointment"},
  ...
  {w:"assert",p:"/əˈsɜːt/",m:"v. 断言",c:"assert authority"},
  ...
  {w:"backward",p:"/ˈbækwəd/",m:"adj. 落后的",c:"backward area"},
  ...
  {w:"betray",p:"/bɪˈtreɪ/",m:"v. 背叛",c:"betray trust"},
  ...
  {w:"bound",p:"/baʊnd/",m:"adj. 一定的",c:"be bound to"},
  ...
  {w:"capture",p:"/ˈkæptʃər/",m:"v. 俘获",c:"capture attention"},
  {w:"career",p:"/kəˈrɪər/",m:"n. 职业",c:"career development"},
  {w:"cargo",p:"/ˈkɑːɡəʊ/",m:"n. 货物",c:"cargo ship"},
  {w:"cast",p:"/kɑːst/",m:"v. 投掷",c:"cast doubt on"},
  ...
  {w:"crash",p:"/kræʃ/",m:"v./n. 碰撞",c:"car crash"},
  ...
  {w:"cultivate",p:"/ˈkʌltɪveɪt/",m:"v. 培养",c:"cultivate habits"},
  ...
  {w:"fault",p:"/fɔːlt/",m:"n. 缺点",c:"find fault with"},
  ...
  {w:"journal",p:"/ˈdʒ�ːnl/",m:"n. 期刊",c:"academic journal"},
