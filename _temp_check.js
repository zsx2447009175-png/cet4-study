...
const DAILY_WORDS = [
  ...
  [{w:"strategy",p:"/ˈstrætədʒi/",m:"n. 策略",c:"business strategy"},{w:"capture",p:"/ˈkæptʃə(r)/",m:"v. 捕获，吸引",c:"capture attention"},{w:"finance",p:"/ˈfaɪnæns/",m:"n. 金融",c:"personal finance"},{w:"achievement",p:"/əˈtʃiːvmənt/",m:"n. 成就",c:"academic achievement"},{w:"monitor",p:"/ˈmɒnɪtə(r)/",m:"v. 监控",c:"monitor the progress"},{w:"controversial",p:"/ˌkɒntrəˈvɜːʃl/",m:"adj. 有争议的",c:"controversial issue"},{w:"alarm",p:"/əˈlɑːm/",m:"n. 警报",c:"fire alarm"},{w:"convince",p:"/kənˈvɪns/",m:"v. 使信服",c:"convince sb of"},{w:"forecast",p:"/ˈfɔːkɑːst/",m:"n./v. 预测",c:"weather forecast"},{w:"competitive",ex:"The industry is highly competitive.",excn:"这个行业竞争激烈。",p:"/kəmˈpetətɪv/",m:"adj. 竞争的",c:"competitive market"},{w:"export",p:"/ɪkˈspɔːt/",m:"v./n. 出口",c:"export goods"},{w:"enhance",ex:"It enhances the experience.",excn:"它提升了体验。",p:"/ɪnˈhɑːns/",m:"v. 提高",c:"enhance performance"},{w:"enterprise",p:"/ˈentəpraɪz/",m:"n. 企业",c:"private enterprise"},{w:"trend",p:"/trend/",m:"n. 趋势",c:"current trend"},{w:"policy",p:"/ˈpɒləsi/",m:"n. 政策",c:"foreign policy"},{w:"cultivate",p:"/ˈkʌltɪveɪt/",m:"v. 培养，耕作",c:"cultivate habits"},{w:"phenomenon",p:"/fəˈnɒmɪnən/",m:"n. 现象",c:"social phenomenon"},{w:"obvious",p:"/ˈɒbviəs/",m:"adj. 明显的",c:"obvious reason"},{w:"accuse",p:"/əˈkjuːz/",m:"v. 指控",c:"accuse of"},{w:"establish",ex:"They established new rules.",excn:"他们制定了新规则。",p:"/ɪˈstæblɪʃ/",m:"v. 建立",c:"establish a company"},{w:"invest",p:"/ɪnˈvest/",m:"v. 投资",c:"invest in"},{w:"insight",p:"/ˈɪnsaɪt/",m:"n. 洞察力",c:"provide insight"},{w:"detail",ex:"Explain it in detail.",excn:"详细解释。",p:"/ˈdiːteɪl/",m:"n. 细节",c:"in detail"},{w:"advocate",p:"/ˈædvəkeɪt/",m:"v. 倡导",c:"advocate for"},{w:"equivalent",p:"/ɪˈkwɪvələnt/",m:"adj. 相等的",c:"equivalent to"},{w:"estimate",ex:"It is estimated that...",excn:"据估计...",p:"/ˈestɪmeɪt/",m:"v. 估计",c:"estimate the cost"},{w:"aboard",p:"/əˈbɔːd/",m:"adv./prep. 在船上",c:"go aboard"},{w:"specific",p:"/spəˈsɪfɪk/",m:"adj. 具体的",c:"specific details"},{w:"confidence",p:"/ˈkɒnfɪdəns/",m:"n. 信心",c:"build confidence"},{w:"priority",p:"/praɪˈɒrəti/",m:"n. 优先事项",c:"top priority"},{w:"derive",ex:"The word derives from Latin.",excn:"该词源自拉丁语。",p:"/dɪˈraɪv/",m:"v. 源于",c:"derive from"},{w:"distinct",ex:"There are two distinct types.",excn:"有两种截然不同的类型。",p:"/dɪˈstɪŋkt/",m:"adj. 明显的",c:"distinct from"},{w:"stable",p:"/ˈsteɪbl/",m:"adj. 稳定的",c:"stable economy"},{w:"determine",ex:"She is determined to succeed.",excn:"她决心成功。",p:"/dɪˈtɜːmɪn/",m:"v. 决定",c:"determine to do"},{w:"intellectual",p:"/ˌɪntəˈlektʃuəl/",m:"adj. 智力的",c:"intellectual property"},{w:"advanced",p:"/ədˈvɑːnst/",m:"adj. 先进的",c:"advanced technology"},{w:"enormous",ex:"It took an enormous effort.",excn:"这花了巨大的努力。",p:"/ɪˈnɔːməs/",m:"adj. 巨大的",c:"enormous amount"},{w:"aim",p:"/eɪm/",m:"n. 目标 v. 瞄准",c:"aim at"},{w:"career",p:"/kəˈrɪə(r)/",m:"n. 职业，生涯",c:"career development"},{w:"source",p:"/sɔːs/",m:"n. 来源",c:"energy source"},{w:"opponent",p:"/əˈpəʊnənt/",m:"n. 对手",c:"political opponent"},{w:"opportunity",p:"/ˌɒpəˈtjuːnəti/",m:"n. 机会",c:"seize the opportunity"},{w:"visible",p:"/ˈvɪzəbl/",m:"adj. 可见的",c:"clearly visible"},{w:"isolate",p:"/ˈaɪsəleɪt/",m:"v. 孤立",c:"isolate from"},{w:"demonstrate",ex:"He demonstrated the product.",excn:"他演示了产品。",p:"/ˈdemənstreɪt/",m:"v. 展示",c:"demonstrate the ability"},{w:"survey",p:"/ˈsɜːveɪ/",m:"n./v. 调查",c:"conduct a survey"},{w:"highlight",p:"/ˈhaɪlaɪt/",m:"v. 强调 n. 亮点",c:"highlight the importance"},{w:"target",p:"/ˈtɑːɡɪt/",m:"n. 目标 v. 以……为目标",c:"achieve the target"},{w:"promote",p:"/prəˈməʊt/",m:"v. 促进，晋升",c:"promote economic growth"},{w:"current",ex:"What is your current job?",excn:"你现在做什么工作？",p:"/ˈkʌrənt/",m:"adj. 当前的",c:"current situation"},{w:"vision",p:"/ˈvɪʒn/",m:"n. 愿景，视力",c:"have a vision"},{w:"capable",ex:"She is capable of leading.",excn:"她有能力领导。",p:"/ˈkeɪpəbl/",m:"adj. 有能力的",c:"be capable of"},{w:"admission",p:"/ədˈmɪʃn/",m:"n. 准许进入",c:"admission ticket"},{w:"valid",p:"/ˈvælɪd/",m:"adj. 有效的",c:"valid passport"},{w:"absolute",p:"/ˈæbsəluːt/",m:"adj. 绝对的",c:"absolute power"},{w:"contact",p:"/ˈkɒntækt/",m:"n./v. 联系",c:"keep in contact"},{w:"digital",ex:"We live in the digital age.",excn:"我们生活在数字时代。",p:"/ˈdɪdʒɪtl/",m:"adj. 数字的",c:"digital age"},{w:"volume",p:"/ˈvɒljuːm/",m:"n. 量，卷",c:"sales volume"},{w:"inspire",p:"/ɪnˈspaɪə(r)/",m:"v. 激励",c:"inspire sb to do"},{w:"combine",p:"/kəmˈbaɪn/",m:"v. 结合",c:"combine with"},{w:"abnormal",p:"/æbˈnɔːml/",m:"adj. 反常的",c:"abnormal behavior"},{w:"aid",p:"/eɪd/",m:"n./v. 帮助",c:"first aid"},{w:"domestic",p:"/dəˈmestɪk/",m:"adj. 国内的，家庭的",c:"domestic market"},{w:"companion",p:"/kəmˈpæniən/",m:"n. 同伴",c:"travel companion"},{w:"agency",p:"/ˈeɪdʒənsi/",m:"n. 代理机构",c:"travel agency"},{w:"maximum",p:"/ˈmæksɪməm/",m:"n./adj. 最大",c:"maximum capacity"},{w:"content",p:"/ˈkɒntent/",m:"n. 内容 adj. 满足的",c:"be content with"},{w:"schedule",p:"/ˈʃedjuːl/",m:"n. 时间表",c:"on schedule"},{w:"component",p:"/kəmˈpəʊnənt/",m:"n. 组件",c:"key component"},{w:"concentrate",ex:"Concentrate on your work.",excn:"专注你的工作。",p:"/ˈkɒnsntreɪt/",m:"v. 集中",c:"concentrate on"},{w:"widespread",p:"/ˈwaɪdspred/",m:"adj. 广泛的",c:"widespread use"},{w:"integrate",p:"/ˈɪntɪɡreɪt/",m:"v. 整合",c:"integrate into"},{w:"evidence",ex:"There is no evidence.",excn:"没有证据。",p:"/ˈevɪdəns/",m:"n. 证据",c:"scientific evidence"},{w:"release",p:"/rɪˈliːs/",m:"v./n. 释放，发布",c:"release a statement"},{w:"abortion",p:"/əˈbɔːʃn/",m:"n. 流产",c:"illegal abortion"},{w:"tendency",p:"/ˈtendənsi/",m:"n. 趋势",c:"have a tendency to"},{w:"abolish",p:"/əˈbɒlɪʃ/",m:"v. 废除",c:"abolish slavery"},{w:"principle",p:"/ˈprɪnsəpl/",m:"n. 原则",c:"basic principle"},{w:"passion",p:"/ˈpæʃn/",m:"n. 热情",c:"have a passion for"},{w:"manufacture",p:"/ˌmænjuˈfæktʃə(r)/",m:"v. 制造",c:"manufacture products"},{w:"voluntary",p:"/ˈvɒləntri/",m:"adj. 自愿的",c:"voluntary work"},{w:"factor",p:"/ˈfæktə(r)/",m:"n. 因素",c:"key factor"},{w:"crucial",ex:"This is a crucial decision.",excn:"这是关键决定。",p:"/ˈkruːʃl/",m:"adj. 至关重要的",c:"crucial to"},{w:"contribute",ex:"Everyone contributed ideas.",excn:"每个人都贡献了想法。",p:"/kənˈtrɪbjuːt/",m:"v. 贡献",c:"contribute to"},{w:"abroad",p:"/əˈbrɔːd/",m:"adv. 到国外",c:"study abroad"},{w:"regulate",p:"/ˈreɡjuleɪt/",m:"v. 调节，管理",c:"regulate the market"},{w:"restore",p:"/rɪˈstɔː(r)/",m:"v. 恢复",c:"restore order"},{w:"absence",p:"/ˈæbsəns/",m:"n. 缺席",c:"in the absence of"},{w:"network",p:"/ˈnetwɜːk/",m:"n. 网络",c:"social network"},{w:"acquaintance",p:"/əˈkweɪntəns/",m:"n. 熟人",c:"make acquaintance"},{w:"deserve",ex:"You deserve a break.",excn:"你该休息了。",p:"/dɪˈzɜːv/",m:"v. 值得",c:"deserve attention"},{w:"maintain",p:"/meɪnˈteɪn/",m:"v. 维持",c:"maintain contact"},{w:"consistent",ex:"Be consistent in your efforts.",excn:"保持努力的一致性。",p:"/kənˈsɪstənt/",m:"adj. 一致的",c:"consistent with"},{w:"witness",p:"/ˈwɪtnəs/",m:"n. 目击者 v. 目睹",c:"witness an event"},{w:"permanent",p:"/ˈpɜːmənənt/",m:"adj. 永久的",c:"permanent resident"},{w:"absurd",p:"/əbˈsɜːd/",m:"adj. 荒谬的",c:"absurd idea"},{w:"constant",p:"/ˈkɒnstənt/",m:"adj. 持续的",c:"constant change"},{w:"embrace",p:"/ɪmˈbreɪs/",m:"v. 拥抱，接受",c:"embrace change"},{w:"conflict",p:"/ˈkɒnflɪkt/",m:"n. 冲突",c:"in conflict with"},{w:"circumstance",p:"/ˈsɜːkəmstæns/",m:"n. 情况",c:"under the circumstances"}],
  [{w:"apply",p:"/əˈplaɪ/",m:"v. 申请",c:"apply for"},{w:"behave",p:"/bɪˈheɪv/",m:"v. 表现",c:"behave well"},{w:"beloved",p:"/bɪˈlʌvd/",m:"adj. 心爱的",c:"beloved wife"},{w:"charity",p:"/ˈtʃærəti/",m:"n. 慈善",c:"charity event"},{w:"alter",p:"/ˈɔːltər/",m:"v. 改变",c:"alter the course"},{w:"burst",p:"/bɜːst/",m:"v. 爆发",c:"burst into tears"},{w:"blend",p:"/blend/",m:"v./n. 混合",c:"blend in"},{w:"bitter",p:"/ˈbɪtər/",m:"adj. 苦的",c:"bitter experience"},{w:"bargain",p:"/ˈbɑːɡɪn/",m:"n. 便宜货 v. 讨价还价",c:"bargain price"},{w:"awkward",p:"/ˈɔːkwəd/",m:"adj. 尴尬的",c:"awkward situation"},{w:"argument",p:"/ˈɑːɡjumənt/",m:"n. 争论",c:"strong argument"},{w:"chart",p:"/tʃɑːt/",m:"n. 图表",c:"flow chart"},{w:"arrest",p:"/əˈrest/",m:"v./n. 逮捕",c:"under arrest"},{w:"cast",p:"/kɑːst/",m:"v. 投掷",c:"cast doubt on"},{w:"broadcast",p:"/ˈbrɔːdkɑːst/",m:"v./n. 广播",c:"live broadcast"},{w:"blank",p:"/blæŋk/",m:"adj. 空白的",c:"blank space"},{w:"bound",p:"/baʊnd/",m:"adj. 一定的",c:"be bound to"},{w:"characteristic",p:"/ˌkærəktəˈrɪstɪk/",m:"n. 特征",c:"key characteristic"},{w:"alcohol",p:"/ˈælkəhɒl/",m:"n. 酒精",c:"alcohol abuse"},{w:"chemical",p:"/ˈkemɪkl/",m:"adj. 化学的",c:"chemical reaction"},{w:"ceremony",p:"/ˈserəməni/",m:"n. 典礼",c:"opening ceremony"},{w:"commercial",p:"/kəˈmɜːʃl/",m:"adj. 商业的 n. 广告",c:"commercial bank"},{w:"column",p:"/ˈkɒləm/",m:"n. 栏目，柱",c:"newspaper column"},{w:"barely",p:"/ˈbeəli/",m:"adv. 几乎不",c:"barely enough"},{w:"civil",p:"/ˈsɪvl/",m:"adj. 公民的",c:"civil rights"},{w:"breed",p:"/briːd/",m:"v. 繁殖 n. 品种",c:"breed animals"},{w:"behalf",p:"/bɪˈhɑːf/",m:"n. 利益，代表",c:"on behalf of"},{w:"battle",p:"/ˈbætl/",m:"n./v. 战斗",c:"battle against"},{w:"celebrate",p:"/ˈselɪbreɪt/",m:"v. 庆祝",c:"celebrate success"},{w:"appoint",p:"/əˈpɔɪnt/",m:"v. 任命",c:"appoint a leader"},{w:"blade",p:"/bleɪd/",m:"n. 刀刃",c:"sharp blade"},{w:"code",p:"/kəʊd/",m:"n. 代码，准则",c:"dress code"},{w:"commission",p:"/kəˈmɪʃn/",m:"n. 委员会，佣金",c:"on commission"},{w:"assure",p:"/əˈʃʊər/",m:"v. 使确信",c:"assure safety"},{w:"being",p:"/ˈbiːɪŋ/",m:"n. 生物，存在",c:"human being"},{w:"cargo",p:"/ˈkɑːɡəʊ/",m:"n. 货物",c:"cargo ship"},{w:"attention",p:"/əˈtenʃn/",m:"n. 注意",c:"pay attention to"},{w:"channel",p:"/ˈtʃænl/",m:"n. 频道，渠道",c:"communication channel"},{w:"bounce",p:"/baʊns/",m:"v. 弹跳",c:"bounce back"},{w:"boundary",p:"/ˈbaʊndri/",m:"n. 边界",c:"set boundaries"},{w:"caution",p:"/ˈkɔːʃn/",m:"n. 小心",c:"with caution"},{w:"bind",p:"/baɪnd/",m:"v. 捆绑",c:"bind together"},{w:"chief",p:"/tʃiːf/",m:"adj. 主要的 n. 首领",c:"chief executive"},{w:"command",p:"/kəˈmɑːnd/",m:"v./n. 命令，掌握",c:"have a command of"},{w:"awful",p:"/ˈɔːfl/",m:"adj. 糟糕的",c:"awful weather"},{w:"ancient",p:"/ˈeɪnʃənt/",m:"adj. 古代的",c:"ancient times"},{w:"alert",p:"/əˈlɜːt/",m:"adj. 警觉的",c:"stay alert"},{w:"cabinet",p:"/ˈkæbɪnət/",m:"n. 橱柜，内阁",c:"filing cabinet"},{w:"angle",p:"/ˈæŋɡl/",m:"n. 角度",c:"from another angle"},{w:"assert",p:"/əˈsɜːt/",m:"v. 断言",c:"assert authority"},{w:"cancel",p:"/ˈkænsl/",m:"v. 取消",c:"cancel order"},{w:"apart",p:"/əˈpɑːt/",m:"adv. 分开",c:"apart from"},{w:"attend",p:"/əˈtend/",m:"v. 参加",c:"attend a meeting"},{w:"betray",p:"/bɪˈtreɪ/",m:"v. 背叛",c:"betray trust"},{w:"classic",p:"/ˈklæsɪk/",m:"adj. 经典的",c:"classic example"},{w:"alongside",p:"/əˌlɒŋˈsaɪd/",m:"prep. 在…旁边",c:"work alongside"},{w:"belief",p:"/bɪˈliːf/",m:"n. 信念",c:"beyond belief"},{w:"boost",p:"/buːst/",m:"v./n. 促进",c:"boost confidence"},{w:"blast",p:"/blɑːst/",m:"n. 爆炸 v. 爆破",c:"blast off"},{w:"billion",p:"/ˈbɪljən/",m:"n. 十亿",c:"billions of"},{w:"commerce",p:"/ˈkɒmɜːs/",m:"n. 商业",c:"e-commerce"},{w:"audience",p:"/ˈɔːdiəns/",m:"n. 观众",c:"target audience"},{w:"clarify",p:"/ˈklærɪfaɪ/",m:"v. 澄清",c:"clarify the point"},{w:"classify",p:"/ˈklæsɪfaɪ/",m:"v. 分类",c:"classify into"},{w:"calculate",p:"/ˈkælkjuleɪt/",m:"v. 计算",c:"calculate risk"},{w:"architecture",p:"/ˈɑːkɪtektʃər/",m:"n. 建筑学",c:"modern architecture"},{w:"argue",p:"/ˈɑːɡjuː/",m:"v. 争论",c:"argue against"},{w:"cease",p:"/siːs/",m:"v. 停止",c:"cease to exist"},{w:"civilization",p:"/ˌsɪvəlaɪˈzeɪʃn/",m:"n. 文明",c:"ancient civilization"},{w:"allowance",p:"/əˈlaʊəns/",m:"n. 津贴",c:"make allowance for"},{w:"arrange",p:"/əˈreɪndʒ/",m:"v. 安排",c:"arrange for"},{w:"bankrupt",p:"/ˈbæŋkrʌpt/",m:"adj. 破产的",c:"go bankrupt"},{w:"applicant",p:"/ˈæplɪkənt/",m:"n. 申请人",c:"job applicant"},{w:"climate",p:"/ˈklaɪmət/",m:"n. 气候",c:"climate change"},{w:"backup",p:"/ˈbækʌp/",m:"n. 备份 v. 支持",c:"data backup"},{w:"assumption",p:"/əˈsʌmpʃn/",m:"n. 假设",c:"make an assumption"},{w:"backward",p:"/ˈbækwəd/",m:"adj. 落后的",c:"backward area"},{w:"bless",p:"/bles/",m:"v. 祝福",c:"bless with"},{w:"biology",p:"/baɪˈɒlədʒi/",m:"n. 生物学",c:"molecular biology"},{w:"burden",p:"/ˈbɜːdn/",m:"n. 负担",c:"heavy burden"},{w:"appointment",p:"/əˈpɔɪntmənt/",m:"n. 约会",c:"make an appointment"},{w:"broad",p:"/brɔːd/",m:"adj. 宽的，广泛的",c:"broad range"},{w:"amount",p:"/əˈmaʊnt/",m:"n. 数量",c:"a large amount of"},{w:"certificate",p:"/səˈtɪfɪkət/",m:"n. 证书",c:"birth certificate"},{w:"beneath",p:"/bɪˈniːθ/",m:"prep. 在…下方",c:"beneath the surface"},{w:"amuse",p:"/əˈmjuːz/",m:"v. 逗乐",c:"amuse oneself"},{w:"candidate",p:"/ˈkændɪdət/",m:"n. 候选人",c:"presidential candidate"},{w:"anchor",p:"/ˈæŋkər/",m:"n. 锚 v. 固定",c:"news anchor"},{w:"apology",p:"/əˈpɒlədʒi/",m:"n. 道歉",c:"make an apology"},{w:"catalog",p:"/ˈkætəlɒɡ/",m:"n. 目录",c:"product catalog"},{w:"announce",p:"/əˈnaʊns/",m:"v. 宣布",c:"announce plans"},{w:"brand",p:"/brænd/",m:"n. 品牌",c:"brand image"},{w:"calendar",p:"/ˈkælɪndər/",m:"n. 日历",c:"lunar calendar"},{w:"ancestor",p:"/ˈænsestər/",m:"n. 祖先",c:"common ancestor"},{w:"asset",p:"/ˈæset/",m:"n. 资产",c:"valuable asset"},{w:"casual",p:"/ˈkæʒuəl/",m:"adj. 随便的",c:"casual clothes"},{w:"combat",p:"/ˈkɒmbæt/",m:"v./n. 战斗",c:"combat crime"},{w:"attractive",p:"/əˈtræktɪv/",m:"adj. 有吸引力的",c:"attractive offer"},{w:"brilliant",p:"/ˈbrɪliənt/",m:"adj. 杰出的",c:"brilliant idea"},{w:"bond",p:"/bɒnd/",m:"n. 纽带，债券",c:"emotional bond"}]
];
